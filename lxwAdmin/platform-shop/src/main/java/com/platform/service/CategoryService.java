...
public interface CategoryService {
    ...
    List<CategoryEntity> queryLists(String  parentId);
    /**
     * 分页统计总数
     *
     * @param map 参数
    ...
    List<CategoryEntity> queryMax( String parentId);

    List<CategoryEntity> queryMin(String parentId);

    List<CategoryEntity> queryPraentName(String parentId);
    List<CategoryEntity> queryParent(String parentId);
    List<CategoryEntity> queryParentNames(String parentId);
}
