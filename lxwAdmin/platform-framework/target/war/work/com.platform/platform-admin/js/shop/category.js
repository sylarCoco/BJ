...
var vm = new Vue({
    ...
    methods: {
        ...
        add: function () {
            vm.showList = false;
            vm.title = "新增";
            vm.category = {isShow: 1, type: 0, level: 'L0', bannerUrl: '', iconUrl: '', imgUrl: '', wapBannerUrl: ''};
            vm.getParent();
            vm.getGoodsType();
        ...
        update: function (event) {
         ...
         getParentCategoryo: function () {
             var parentId = this.parentId;

             if(parentId==""){
                 return;
             }
             $.get("../goodsType/getCategorySelecting?parentId=" + parentId, function (r) {
                 vm.categoryList = r.list;
             });
             },
        getParent:function(){
            $.get("../goodsType/listing", function (r) {
                vm.goodsTypes = r.list;
            });
         },
